...
parser.add_argument("--comment", default='ship_13_2', type=str)
...
parser.add_argument("--pretrained", default='checkpoints/epoch=29-step=8039_ship13_2.ckpt',type=str, help="pretrained checkpoint path")
#parser.add_argument("--checkpoints", default='checkpoints/final_model_ship.pth',type=str, help="checkpoint path")
